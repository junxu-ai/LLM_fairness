...
### Summary
The three types of fairness metrics—embedding-based, probability-based, and generation-based—provide a comprehensive framework for evaluating biases in large language models (LLMs). Each type focuses on different aspects of model behavior, from underlying representations to output generation, helping researchers and practitioners identify and mitigate biases effectively.

Citations:
[1] https://montrealethics.ai/bias-and-fairness-in-large-language-models-a-survey/
[2] https://arxiv.org/html/2308.10149v2
[3] https://arxiv.org/html/2404.01349v1
[4] https://www.nature.com/articles/s41598-022-07939-1
